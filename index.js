const  XBOT = 'BOT 8 BIT'; // Nama Bot Whatsapp
const instagram = 'g ada'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+6282131022499'; // Nomor whatsapplu cok
const aktif = 'Tergantung jaringan'; // Kapan bot lu aktif
const groupwa = 'g ada'; // OFFICIAL GRUP LU 1
const youtube = 'g ada'; 
...
conn.sendMessage(id, 'Aku BOT nya Nekko' ,MessageType.text);
}
else if (text == 'kntl'){
conn.sendMessage(id, 'njir toxic' ,MessageType.text);
}
